...
EMAIL_HOST_USER = os.getenv('EMAIL_USER')  # Your email address for authentication
# EMAIL_HOST_USER = 'cranerb7@gmail.com'
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_PASSWORD')  # Your email password or app-specific password
# EMAIL_HOST_PASSWORD = '' 
